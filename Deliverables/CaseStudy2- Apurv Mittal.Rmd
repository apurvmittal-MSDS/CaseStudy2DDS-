...
originalData = read.csv("/Users/apurv/Documents/SMU/6306 - Doing Data Science/DS Project 2/CaseStudy2DDS/CaseStudy2-data.csv", header = TRUE)

# This is competition dataset for Attrition
test_Attrition<-read.csv("/Users/apurv/Documents/SMU/6306 - Doing Data Science/DS Project 2/CaseStudy2CompSet No Attrition.csv", header = TRUE)

# This is competition dataset for Monthly Income 
test_MI<- read_excel("/Users/apurv/Documents/SMU/6306 - Doing Data Science/DS Project 2/CaseStudy2CompSet No Salary.xlsx", col_names = TRUE)
...
originalData%>%ggplot(aes(JobLevel, fill = Attrition))+ geom_bar(position = "dodge") + theme_economist() 

# Job Role and Attrition plot

originalData%>%ggplot(aes(JobRole, fill = Attrition))+ geom_bar(position = "dodge") + theme_economist() + theme(axis.text.x = element_text(angle = 90, hjust = 0 ,vjust = 0.5, size = 6))

# Job Involvement and Attrition plot

originalData%>%ggplot(aes(JobInvolvement, fill = Attrition))+ geom_bar(position = "dodge") + theme_economist() 

# Job Satisfaction and Attrition plot

originalData%>%ggplot(aes(JobSatisfaction, fill = Attrition))+ geom_bar(position = "dodge") + theme_economist() 
...
data.ds%>%ggplot(aes(JobLevel, fill = Attrition))+ geom_bar(position = "dodge") + theme_economist() 

# Job Role and Attrition plot

data.ds%>%ggplot(aes(JobRole, fill = Attrition))+ geom_bar(position = "dodge") + theme_economist() + theme(axis.text.x = element_text(angle = 90, hjust = 0 ,vjust = 0.5, size = 6))

# Job Involvement and Attrition plot

data.ds%>%ggplot(aes(JobInvolvement, fill = Attrition))+ geom_bar(position = "dodge") + theme_economist() 

# Job Satisfaction and Attrition plot

data.ds%>%ggplot(aes(JobSatisfaction, fill = Attrition))+ geom_bar(position = "dodge") + theme_economist() 
...
data.ds%>%ggplot(aes(Age, DistanceFromHome,colour = Attrition))+ geom_point()+ theme_economist() 

# Check if Stock Option (with and without Income) plays a role towards Attrition


data.ds%>%ggplot(aes(StockOptionLevel, MonthlyIncome, colour = Attrition))+ geom_boxplot()+
  theme(axis.text.x = element_text(angle = 60, hjust = 1,size = 8), axis.text.y = element_text(hjust = 1,size = 6))+theme_economist()


data.ds%>%ggplot(aes(StockOptionLevel, fill = Attrition))+ geom_bar(position = "dodge")+
  theme(axis.text.x = element_text(angle = 60, hjust = 1,size = 8), axis.text.y = element_text(hjust = 1,size = 6))+theme_economist()
...
data.ds%>%ggplot(aes(OverTime, MonthlyIncome, colour = Attrition))+ geom_boxplot()+
  theme(axis.text.x = element_text(angle = 60, hjust = 1,size = 8), axis.text.y = element_text(hjust = 1,size = 6))

data.ds%>%ggplot(aes(OverTime, fill = Attrition))+ geom_bar(position = "dodge")+
  theme(axis.text.x = element_text(angle = 60, hjust = 1,size = 8), axis.text.y = element_text(hjust = 1,size = 6))

# Check if Number of Companies Worked (with and without Income) plays a role towards Attrition


data.ds%>%ggplot(aes(NumCompaniesWorked, MonthlyIncome, colour = Attrition))+ geom_boxplot()+
  theme(axis.text.x = element_text(angle = 60, hjust = 1,size = 8), axis.text.y = element_text(hjust = 1,size = 6))

data.ds%>%ggplot(aes(NumCompaniesWorked, fill = Attrition))+ geom_bar(position = "dodge")+
  theme(axis.text.x = element_text(angle = 60, hjust = 1,size = 8), axis.text.y = element_text(hjust = 1,size = 6))


# Check if Marital Status (with and without Income) plays a role towards Attrition

data.ds%>%ggplot(aes(MaritalStatus, MonthlyIncome, colour = Attrition))+ geom_boxplot()+
  theme(axis.text.x = element_text(angle = 60, hjust = 1,size = 8), axis.text.y = element_text(hjust = 1,size = 6))

data.ds%>%ggplot(aes(MaritalStatus, fill = Attrition))+ geom_bar(position = "dodge")+
  theme(axis.text.x = element_text(angle = 60, hjust = 1,size = 8), axis.text.y = element_text(hjust = 1,size = 6))


# Check if Gender (with and without Income) plays a role towards Attrition

data.ds%>%ggplot(aes(Gender, MonthlyIncome, colour = Attrition))+ geom_boxplot(position = "dodge")+
  theme(axis.text.x = element_text(angle = 60, hjust = 1,size = 8), axis.text.y = element_text(hjust = 1,size = 6))

data.ds%>%ggplot(aes(Gender, fill = Attrition))+ geom_bar(position = "dodge")+
  theme(axis.text.x = element_text(angle = 60, hjust = 1,size = 8), axis.text.y = element_text(hjust = 1,size = 6))
...
print(paste("Best Accuracy at K = ", which.max(MeanAcc), "of", max(MeanAcc)*100,"%"))
